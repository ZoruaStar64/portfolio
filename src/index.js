...
function Page() {
  ...
  //These are the types of page styles (they will be used when simple dark/light mode are made).
  const pageThemes = ['Dark', 'Light', 'Simple Dark', 'Simple Light'];
  // this function toggles the page style once the theme button gets clicked
  const [togglePageStyle, setPageStyle] = useState('Dark');
        ...
        <div>
            ...
            <div className='headerBackground purpleToWhite'> 
              ...
              <div className='styleButtonContainer'>
                <motion.img id='styleSwitchButton' animate={{rotateZ: 360}} transition={{repeatDelay: 2, repeat: Infinity, duration: 10}} onClick={()=>toggleStyle('Dark')} src={darkModeButton} className='darkModeButton' title='Dark mode button'>
                </motion.img>
              </div>
            ...
            <div className='headerBackground blueToDarkBlue'>
              ...
              <div className='styleButtonContainer'>
                <motion.img id='styleSwitchButton' animate={{rotateZ: 360}} transition={{repeatDelay: 2, repeat: Infinity, duration: 10}} onClick={()=>toggleStyle('Light')} src={lightModeButton} className='darkModeButton' title='Light mode button'>
                </motion.img>
              </div>
            ...
            :
            <div className='headerBackground blueToDarkBlue'>
              {/* This is the Default state for now. */}
              <div onClick={toggleStarText} className='nameAndProfession darkStarContainer'>
              {!switchStarText ?
                <div className='nameH1'>
                  <h1>Sander</h1>
